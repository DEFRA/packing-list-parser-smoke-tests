...
export const config = {
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `packing-list-parser-smoke-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `packing-list-parser-smoke-tests-${process.env.ENVIRONMENT}`
        },
